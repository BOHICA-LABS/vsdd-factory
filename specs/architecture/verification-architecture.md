...
| VP-124 | Backfill-Split Is Atomic Under Interruption, Idempotent Against an Already-Sharded Artifact, and Recovery-Confirmation Is Exact-Manifest-Based Never a Byte-Prefix Heuristic (EXTENDED v1.6: SAFE/DANGEROUS/AMBIGUOUS disposition determined SOLELY by exact whole-file (length, SHA-256) comparison against the Backfill Recovery Manifest — a repeated-prefix content case, EC-009, is correctly classified SAFE, and a match against neither manifest pair fails loud as E-SHD-011, EC-010) | integration | BC-1.18.008 PC5(Recovery-Confirmation Rule, NEW)/PC6/INV3(tightened)/EC-003/EC-004/EC-009(NEW)/EC-010(NEW) | draft |
