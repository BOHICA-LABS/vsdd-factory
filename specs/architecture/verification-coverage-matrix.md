...
| VP-124 | Backfill-Split Atomic Under Interruption + Idempotent + Recovery-Confirmation Exact-Manifest-Based, Never a Byte-Prefix Heuristic (EXTENDED v1.6: NEW Backfill Recovery Manifest §PC3, NEW Recovery-Confirmation Rule §PC5, tightened §INV3, EC-009/EC-010, `E-SHD-011`) (BC-1.18.008) | SS-01 | | | | ✓ | | |
