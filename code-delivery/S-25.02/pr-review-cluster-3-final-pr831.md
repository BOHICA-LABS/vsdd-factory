...
> **Archive note (added by pr-reviewer, cluster-4 cycle-3):** this file preserves the
> cluster-3 final review verbatim. It previously occupied the canonical
> `pr-review.md` slot, which has been reassigned to the current open PR (#832,
> cluster-4). No content below has been altered.
